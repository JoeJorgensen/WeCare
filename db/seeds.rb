...
d3 = Donation.create(comment: 'Good Luck!', amount: 450.00, anonymous: false, user_id:u4.id, campaign_id:c4.id, created_at: 'July 10th 2020 12:10')
d3 = Donation.create(comment: 'That sucks :(', amount: 600.00, anonymous: false, user_id:u4.id, campaign_id:c2.id, created_at: 'June 20th 2021 11:10')
...
d6 = Donation.create(comment: '#VegasStrong', amount: 100.00, anonymous: false, user_id:u7.id, campaign_id:c6.id, created_at: 'September 1st 2021 09:00')
d7 = Donation.create(comment: '#VegasStrong', amount: 100.00, anonymous: false, user_id:u7.id, campaign_id:c6.id, created_at: 'September 10th 2021 10:00')
d8 = Donation.create(comment: '#VegasStrong', amount: 100.00, anonymous: false, user_id:u7.id, campaign_id:c6.id, created_at: 'September 20th 2021 11:00')
d9 = Donation.create(comment: '#VegasStrong', amount: 100.00, anonymous: false, user_id:u7.id, campaign_id:c6.id, created_at: 'September 30th 2021 12:00')
...
cat1 = Category.create(name:'Animals')
cat2 = Category.create(name:'Business')
cat3 = Category.create(name:'Community')
cat4 = Category.create(name:'Creative')
cat5 = Category.create(name:'Education')
cat6 = Category.create(name:'Emergencies')
cat7 = Category.create(name:'Environment')
cat8 = Category.create(name:'Events')
cat9 = Category.create(name:'Faith')
cat10 = Category.create(name:'Family')
cat11 = Category.create(name:'Funeral & Memorial')
cat12 = Category.create(name:'Medical')
cat13 = Category.create(name:'Monthly Bills')
cat14 = Category.create(name:'Newlyweds')
cat15 = Category.create(name:'Other')
cat16 = Category.create(name:'Sports')
