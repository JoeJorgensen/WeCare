...
u5 = User.create(name: 'Joe', email: 'joe@test.com', password: '123456', image: 'https://www.w3schools.com/howto/img_avatar.png', balance: 1000.00 )
u6 = User.create(name: 'Steve', email: 'steve@test.com', password: '123456', image: 'https://www.w3schools.com/howto/img_avatar.png', balance: 1000.00 )
u7 = User.create(name: 'Randy', email: 'randy@test.com', password: '123456', image: 'https://www.w3schools.com/howto/img_avatar.png', balance: 1000.00 )



c1 = Campaign.create(name: 'Matt Hays Memorial Fund', description: 'Matt Hays Memorial', image: 'https://2dbdd5116ffa30a49aa8-c03f075f8191fb4e60e74b907071aee8.ssl.cf1.rackcdn.com/6879821_1447383818.6328.jpg', current_amount: 5000.00, goal: 15000.00, expiration: 'May 3rd 2022 10:10', user_id:u1.id)
c2 = Campaign.create(name: 'Barn Fire', description: 'Barn has been burnt up', image: 'https://img.hobbyfarms.com/wp-content/uploads/2018/01/18040448/barn-fire-safety-1928639.jpg', current_amount: 2000.00, goal: 20000.00, expiration: 'June 16th 2022 10:10', user_id:u2.id)
c3 = Campaign.create(name: 'House Fire', description: 'House has been burnt up', image: 'https://www.puroclean.com/wp-content/uploads/2019/08/AdobeStock_166647716-1.jpeg', current_amount: 4500.00, goal: 25000.00, expiration: 'April 1st 2022 10:10', user_id:u2.id)
c4 = Campaign.create(name: 'New Business', description: 'Opening up a new Business in NYC', image: 'https://www.laytoncity.org/LC/CommunityCalendar/RenderImageOrFile/0abce416-ee2d-4da6-97ce-4f6d4e554867', current_amount: 1750.00, goal: 15000.00, expiration: 'December 30th 2022 10:10', user_id:u5.id)
c5 = Campaign.create(name: 'Forge Fundraising', description: 'New Blacksmith in town', image: 'https://nt.global.ssl.fastly.net/images/1431820118708-webericmcdonaldanvilfireattheforgeeastdevonbranscombe.jpg?width=1920&auto=webp&crop=16:7', current_amount: 9500.00, goal: 25000.00, expiration: 'November 1st 2022 10:10', user_id:u4.id)
c6 = Campaign.create(name: 'Vegas Kids Basketball Program', description: 'AAU team for the community', image: 'https://vegasfamilyevents.com/wp-content/uploads/2019/09/vegas-kids-sports-featured-image-640x480.jpg', current_amount: 4250.00, goal: 22500.00, expiration: 'September 10th 2022 10:10', user_id:u7.id)
c7 = Campaign.create(name: 'Utah Kids Football Program', description: 'Youth kids, Football 4 Families', image: 'https://az388273.vo.msecnd.net/campsystem/images/1/CampAccountBanner_50e7aa13a8854af69583f3b79048af8b.jpg', current_amount: 7000.00, goal: 26000.00, expiration: 'October 26th 2022 10:10', user_id:u6.id)
...
d3 = Donation.create(comment: 'Hope this helps you out!', amount: 450.00, anonymous: false, user_id:u4.id, campaign_id:c5.id)
d4 = Donation.create(comment: 'Congrats! Goodluck', amount: 400.00, anonymous: false, user_id:u5.id, campaign_id:c4.id)
d5 = Donation.create(comment: 'This should help the team! #UTAH', amount: 500.00, anonymous: false, user_id:u6.id, campaign_id:c7.id)
d6 = Donation.create(comment: '#VegasStrong', amount: 400.00, anonymous: false, user_id:u7.id, campaign_id:c6.id)
d7 = Donation.create(comment: '#VegasStrong', amount: 400.00, anonymous: false, user_id:u7.id, campaign_id:c6.id)
d8 = Donation.create(comment: '#VegasStrong', amount: 400.00, anonymous: false, user_id:u7.id, campaign_id:c6.id)
d9 = Donation.create(comment: '#VegasStrong', amount: 400.00, anonymous: false, user_id:u7.id, campaign_id:c6.id)
d10 = Donation.create(comment: 'Oh no, the barn', amount: 120.00, anonymous: false, user_id:u3.id, campaign_id:c3.id)
